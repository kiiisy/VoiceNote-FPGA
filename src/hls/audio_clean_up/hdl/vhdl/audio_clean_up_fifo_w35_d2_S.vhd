...
entity audio_clean_up_fifo_w35_d2_S is 
    generic (
        MEM_STYLE         : string  := "shiftReg";
        DATA_WIDTH        : integer := 35;
...
architecture rtl of audio_clean_up_fifo_w35_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component audio_clean_up_fifo_w35_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 35;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_audio_clean_up_fifo_w35_d2_S_ShiftReg : audio_clean_up_fifo_w35_d2_S_ShiftReg
    generic map (
...
entity audio_clean_up_fifo_w35_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 35;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end audio_clean_up_fifo_w35_d2_S_ShiftReg;

architecture rtl of audio_clean_up_fifo_w35_d2_S_ShiftReg is
