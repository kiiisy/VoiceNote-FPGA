...
module audio_clean_up_audio_clean_up_Pipeline_READ_FROM_PORT (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln32_fu_89_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln32_fu_89_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((in_stream_full_n == 1'b0) | (s_axis_TVALID == 1'b0));
end
...
assign i_9_fu_95_p2 = (ap_sig_allocacmp_i_8 + 2'd1);

assign icmp_ln32_fu_89_p2 = ((ap_sig_allocacmp_i_8 == 2'd2) ? 1'b1 : 1'b0);

assign in_stream_din = {{s_axis_TID}, {s_axis_TDATA}};

endmodule //audio_clean_up_audio_clean_up_Pipeline_READ_FROM_PORT
